...
namespace TwitterStreamClient
{
    public class TwitterStream : OAuthBase
    {
        ...
        public async Task<IEnumerable<string>> GetTweetsStream(string accessToken = null)
        {
            if (accessToken == null)
            {
            ...
            var requestUserTimeline = new HttpRequestMessage(HttpMethod.Get, ConfigurationManager.AppSettings["stream_url"]);
        ...
        public async Task<string> GetAccessToken()
        {
            ...
            var customerInfo = Convert.ToBase64String(new UTF8Encoding()
                                      .GetBytes(customer_key + ":" + customer_secret));
